This folder contains JaveScript code written to calculate river ice extent for gauge locations to evaluate river ice extent against in situ observations of river ice.
